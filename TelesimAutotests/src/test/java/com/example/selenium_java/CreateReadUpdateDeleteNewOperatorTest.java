...
public class CreateReadUpdateDeleteNewOperatorTest {
    ...
    @Test
    public void createReadUpdateDeleteNewOperatorTest() throws InterruptedException {
        adminPage.login();
...
//        newUser.click();
        ...
        assertEquals(pagination, "0 of 0 operators");
    }
}
