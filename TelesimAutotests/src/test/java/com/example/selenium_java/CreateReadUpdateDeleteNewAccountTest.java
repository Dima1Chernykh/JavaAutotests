...
public class CreateReadUpdateDeleteNewAccountTest {
    ...
    @Test
    public void createReadUpdateDeleteNewAccountTest() throws InterruptedException {
        adminPage.login();
        ...
        assertEquals(($(By.xpath("/html/body/div[1]/div/div/div/main/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr/td[2]/span[1]")).getText()), randomNameForAssert);
        assertEquals(($(By.xpath("/html/body/div[1]/div/div/div/main/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr/td[2]/span[2]")).getText()), randomEmail);
        assertEquals(($(By.xpath("/html/body/div[1]/div/div/div/main/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr/td[8]/span")).getText()), "Unverified");
        ...
        blockButton.click();
        backButton.click();
        assertEquals(($(By.xpath("/html/body/div[1]/div/div/div/main/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr/td[8]/span")).getText()), "Blocked");
        newUser.click();
